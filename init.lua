...
require('lazy').setup({
  ...
  {'mfussenegger/nvim-dap',
    ...
    config = function()
      ...
      set('n', '<Leader>B', require('dap').set_breakpoint)
      set('n', '<Leader>lp>', require('dap').set_breakpoint)
      set('n', '<Leader>dr>', require('dap').repl.open)
      set('n', '<Leader>dl>', require('dap').run_last)
    end,
  },
